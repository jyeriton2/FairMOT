...
from .dla import get_pose_net as get_dla_dcn
from .VIT import get_pose_net as get_vit
...
def load_model(model, model_path, optimizer=None, resume=False, lr=None, lr_step=None):
    ...
    print('loaded {}, epoch {}'.format(model_path, checkpoint['epoch']))    #ToDo write log
