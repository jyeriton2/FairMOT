...
from .lib.models.loss import FocalLoss, RegL1Loss, RegLoss, NormRegL1Loss, RegWeightedL1Loss
from .lib.models.util import _transpose_and_gather_feat, _sigmoid
from .lib.image_utils import ctdet_post_process
from .lib.basetrain import BaseTrainer
    ...
    def forward(self, outputs, batch):
        ...
        for s in range(opt.num_stacks):
            ...
            if opt.id_weight > 0:
                ...
                id_head = self.emb_scale * nn.functional.normalize(id_head)
